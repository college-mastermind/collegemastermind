...
export const metadata = {
  title: "Terms and Conditions - College Mastermind",
  description: "",
};
...
const TermsandConditionsPage = () => {
  return (
    <div className="mt-32 flex">
      <div className="mx-auto max-w-[90%] w-[1280px]">
        <h1 className="text-4xl font-bold text-center">Terms and Conditions</h1>
        <p className="mt-10">
          Welcome to collegemastermind.com! Collegemastermind.com will provide
          access to certain content on its website to guide users through the
          process of becoming a student at educational institutions, including
          information respecting visa applications and program information
          <br />
          <br />
          These terms and conditions outline the rules and regulations for the
          use of College Mastermind&apos;s Website, located at
          www.collegemastermind.com.
          <br />
          <br />
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use collegemastermind.com if you do not
        ...
        <p className="mt-2">
          Collegemastermind.com will provide users, through its website, with
          the ability to input information regarding their educational
          background and other personal data. Our agents will act as an
          intermediary to applicable educational institutions. As such, we have
          the right to send your information to agreed-upon universities with
          your explicit permission.
        </p>
        <h2 className="text-2xl font-bold mt-10">Service Changes</h2>
        <p className="mt-2">
          Collegemastermind.com reserves the right to alter, suspend, or
          discontinue services at any time
        </p>
        <h2 className="text-2xl font-bold mt-10">Cookies</h2>
        <p className="mt-2">
          We employ the use of cookies. By accessing collegemastermind.com, you
          agreed to use cookies in agreement with the College Mastermind&apos;s
          Privacy Policy.
          <br />
          <br />
        ...
        <h2 className="text-2xl font-bold mt-10">License</h2>
        <p className="mt-2">
          Unless otherwise stated, College Mastermind and/or its licensors own
          the intellectual property rights for all material on
          collegemastermind.com. All intellectual property rights are reserved.
          You may access this from collegemastermind.com for your own personal
        ...
        <ul className="list-disc ml-6">
          <li>Republish material from collegemastermind.com</li>
          <li>Sell, rent or sub-license material from collegemastermind.com</li>
          <li>
            Reproduce, duplicate or copy material from collegemastermind.com
          </li>
          <li>Redistribute content from collegemastermind.com</li>
        </ul>
        <p className="mt-10">
          ...
          College Mastermind does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of College Mastermind ,its agents and/or
          ...
          laws, College Mastermind shall not be liable for the Comments or for
          ...
          <br />
          <br />
          College Mastermind reserves the right to monitor all Comments and to
        ...
        <p className="mt-4">
          You hereby grant College Mastermind a non-exclusive license to use,
        ...
        <p className="mt-4">
          ...
          the hyperlink compensates the absence of College Mastermind ; and (d)
        ...
        <p className="mt-4">
          ...
          sending an e-mail to College Mastermind . Please include your name,
        ...
        <p className="mt-4">
          No use of College Mastermind 's logo or other artwork will be allowed
          for linking absent a trademark license agreement.
        </p>
        <h2 className="text-2xl font-bold mt-10">iFrames</h2>
        <p className="mt-4">
          Without prior approval and written permission, you may not create
          frames around our Webpages that alter in any way the visual
          presentation or appearance of our Website.
        </p>
        <h2 className="text-2xl font-bold mt-10">Content Liability</h2>
        <p className="mt-4">
        ...
        <h2 className="text-2xl font-bold mt-10">Your Privacy</h2>
        <p className="mt-4">Please read Privacy Policy</p>
        <h2 className="text-2xl font-bold mt-10">Reservation of Rights</h2>
        <p className="mt-4">
