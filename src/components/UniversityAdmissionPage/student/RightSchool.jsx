        ...
        >
          ...
          <div className="flex flex-col items-center w-full md:w-4/6 space-y-3 lg:w-2/3 lg:space-y-4">
            ...
            w-full h-40 xl:h-48  shadow-inner-[0px_8px_8px_-4px_rgba(0,0,0,0.03)] shadow-[0px_20px_24px_-4px_rgba(0,0,0,0.08) pt-10"
                >
                  <h1 className="text-4xl font-bold mb-1 md:text-4xl xl:text-6xl text-shadow-[0px_4px_4px_rgb(0_0_0/_0.25)]">
                    2
                  </h1>
                  <h4 className="text-base md:text-lg xl:text-xl text-shadow-[0px_4px_4px_rgb(0_0_0/_0.25)]">
                    Sessions
                  </h4>
                </div>
                <div className="bg-gradient-to-b from-[#447EF7] to-[#243DBC] text-white text-center mt-6 rounded-xl w-full h-40 xl:h-48 pt-12 xl:pt-14 flex-col justify-center items-center">
                  ...
                  {ambassador.map((text, index) => (
                    ...
                    >
                      <Image
                        src={check}
                        alt="Check-icon"
                        className="rounded-full w-3 h-3 mt-0.5 sm:mt-1 sm:w-4 sm:h-4 md:mt-1 md:w-3 md:h-3 lg:w-4 lg:h-4 xl:mt-1.5"
                      />
                      <p
                        className="text-xs text-gray-600 sm:text-base md:text-base xl:text-lg"
                ...
                {everything.map((text, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <Image
                      src={check}
                      alt="Check-icon"
                      className="rounded-full w-3 h-3 mt-0.5 sm:mt-1  lg:w-4 lg:h-4 lg:mt-1.5 "
                    />
          ...
          gap-3 sm:p-5 md:flex-col md:gap-2 xl:py-5"
            >
              <Image
                src={zoom}
                alt="Zoom-Icon"
                className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 xl:h-12 xl:w-12"
              />
