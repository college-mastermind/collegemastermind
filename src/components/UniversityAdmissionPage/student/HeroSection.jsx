  ...
  return (
    ...
    >
      <div className="flex flex-col pt-5 items-center justify-center text-center lg:pt-7">
        ...
        <p className="px-6 max-w-80 sm:max-w-full block text-[16px] sm:text-[19px] md:text-[22px] lg:text-[28px] lg:font-normal text-white text-center mb-8 sm:mb-12 md:mb-16 lg:mb-16 text-lg">
