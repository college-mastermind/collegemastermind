  ...
  return (
    <div className="flex flex-row gap-[12px]">
      <Image
        src={CheckTickIcon}
        alt=""
        className="w-6 h-6 md:w-[30px] md:h-[30px] object-contain rounded-full shadow-[0px_14px_34px_0px_#0208351a]"
      />
...
const GradesHelpComponent = () => {
  return (
    <div className="flex flex-col sm:flex-row gap-10 md:gap-0 items-center my-10">
      <div className="w-full md:w-[60%] flex flex-col text-center sm:text-left md:pr-10">
        <h2 className={`${textGradient} text-4xl md:text-5xl pb-2 font-bold`}>
          Don&apos;t Worry About Grades
        </h2>
        <p className="text-lg md:text-[26px] mt-2">
