  ...
  return (
    <div className="relative w-full mb-16 h-[400px] sm:h-[500px] md:h-[640px] lg:h-[700px] flex items-center justify-center text-center bg-cover bg-center" style={{ backgroundImage: `url(${heroImage.src})` }}>
      <div className='flex flex-col items-center justify-center text-center lg:pt-7'>
        ...
        <p className="px-4 block text-[16px] sm:text-[19px] md:text-[22px] lg:text-[24px] text-white text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 text-lg">
        ...
        <a
          ...
          target='_blank'
          className="bg-white text-blue-500 font-semibold border border-blue-500 rounded-lg transition duration-300 ease-in-out transform hover:bg-blue-500 hover:text-white hover:shadow-lg flex items-center justify-center w-[145px] sm:w-[155px] md:w-[170px] lg:w-[187px] shadow-[4px_4px_10px_rgba(0,0,0,0.2)]"
          style={{ height: '50px' }}
        >
          Join Now!
        </a>
