...
const Adam = () => {
  return (
    ...
    sm:px-12 md:px-8 flex flex-col md:flex-row items-center justify-between
     max-w-8xl mx-auto lg:px-14 xl:px-28">
       ...
       md:w-2/3 md:items-start md:text-left xl:pl-12 xl:gap-10  mt-4">
        ...
        <div className="rounded-full overflow-hidden">
          <Image
            ...
            // width={140}
            // height={140}
            className="object-cover w-[140px] h-[140px] md:w-36 md:h-36 rounded-full"
          />
        </div>
        
        {/* Text Content */}
        <div className='md:w-1/2'>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-[#447EF7] to-[#243DBC] text-transparent bg-clip-text">Adam</h2>
          <p className="text-gray-700 text-sm md:text-base mt-2 md:mt-0">
      ...
      {/* Right Section */}
      <div className="w-full  md:w-2/5 lg:w-2/4 flex flex-col items-start 
      text-left sm:text-center sm:items-center mt-10 md:mt-0 md:items-start md:text-left">
        <h3 className="text-2xl font-bold bg-gradient-to-r from-[#447EF7] to-[#243DBC] text-transparent bg-clip-text">Join Your Squad Today!</h3>
        <p className="text-gray-700 text-sm md:text-base mt-2 md:mt-0">
