...
const GoogleForm = () => {
  return (
    <div className="flex flex-col items-center justify-center pt-7 md:pt-16 min-h-screen">
      {/* Heading Section */}
      <div className="max-w-2xl text-center px-4 md:max-w-3xl">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl lg:tracking-tighter font-semibold bg-gradient-to-r from-[#447EF7] to-[#243DBC] text-transparent bg-clip-text mb-5 md:mb-8">
          Claim Your Spot Today
        </h2>
        <p className="text-gray-700 text-base md:text-lg xl:text-xl max-w-[380px] md:max-w-[510px] lg:max-w-2xl sm:mx-auto">
