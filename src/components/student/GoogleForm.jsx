  ...
  return (
    <div className="flex flex-col items-center justify-center pt-7 md:pt-16 min-h-screen">
      ...
      <div className="max-w-2xl text-center px-4 md:max-w-3xl">
        ...
        <p className="text-gray-700 text-base  lg:text-xl max-w-[380px] md:max-w-[510px] lg:max-w-2xl sm:mx-auto">
          Our tutors have a{" "}
          <span className="font-bold">
            limited number of spots each month.{" "}
          </span>
          Don’t miss the chance to fast-track your path to an SAT score of 1500+
          for free.
        </p>
      </div>
